function TopHeader() {
  return (
    <div className="desktop:w-full w-full border-b border-[#EDEDED] flex flex-col items-center">
      <div className="desktop:w-[90%] max-w-[var(--max-width)] w-full flex items-center justify-between py-[10px]">
