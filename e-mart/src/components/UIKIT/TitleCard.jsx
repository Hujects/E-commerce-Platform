export default function TitleCard() {
  return (
    <div className="self-start flex-shrink-0 flex items-center gap-[10px] p-[15px] border border-[var(--cultured)] max-w min-w-[280px] md:min-w-[calc(50% - 15px)] lg:min-w-[calc(33.33% - 20px)] xl:min-w-[calc(25% - 22.5px)]">
