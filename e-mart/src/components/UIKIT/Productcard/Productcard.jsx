      ...
      <div>
        <div className="mt-7 p-3 flex border border_full rounded-2xl text-[var(--fs-7)]">
          ...
          <div className="flex-1">
            ...
            <p className="text-[var(--spanish-gray)] text-justify">
            ...
            <div className="flex items-center gap-4 mt-4">
              <span className="text-[24px] text-[var(--salmon-pink)] font-bold">
                $19.99
              </span>
            ...
            <div className="flex justify-between">
              <p>
                Already sold: <span className="font-medium">20</span>
              </p>
              <p>
                AVAILABLE: <span className="font-medium">40</span>
              </p>
            </div>
            <div className="progress_bar my-3">
              <div className="w-full h-1.5 bg-gray-200 rounded-full overflow-hidden">
                <div
                  className="h-full bg-[var(--salmon-pink)] rounded-full transition-all duration-300"
                  style={{ width: `${33.33}%` }}
                ></div>
              </div>
            </div>
